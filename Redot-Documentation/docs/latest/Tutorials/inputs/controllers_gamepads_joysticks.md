...
[report bugs on GitHub](https://github.com/redot-engine/redot-engine/blob/master/CONTRIBUTING.md#reporting-bugs).
...
[known issues with controller support ](https://github.com/redot-engine/redot-engine/issues?q=is%3Aopen+is%3Aissue+label%3Atopic%3Ainput+gamepad)
on GitHub.
