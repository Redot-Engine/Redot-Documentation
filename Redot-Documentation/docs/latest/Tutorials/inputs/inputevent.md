...
![Image](/img/Tutorials/inputs/img/input_event_flow.webp)
...
![Image](/img/Tutorials/inputs/img/input_event_scene_flow.webp)
...
See [doc_first_3d_game_input_actions](doc_02.player_input#creating-input-actions) for a tutorial on adding input
