...
![Image](/img/Tutorials/xr/img/android_gradle_build.webp)
...
![Image](/img/Tutorials/xr/img/openxr_loader_asset_lib.webp)

You will find the installed files inside the **addons** folder.

Alternatively you can manually install the vendors plugin by downloading the v2.x version of the plugin [from the release page here ](https://github.com/GodotVR/godot_openxr_vendors/releases).
...
![Image](/img/Tutorials/xr/img/xr_enable_vendors_plugin.webp)
...
![Image](/img/Tutorials/xr/img/android_meta_quest.webp)
...
![Image](/img/Tutorials/xr/img/xr_export_features.webp)
...
![Image](/img/Tutorials/xr/img/android_one_click_deploy.webp)
