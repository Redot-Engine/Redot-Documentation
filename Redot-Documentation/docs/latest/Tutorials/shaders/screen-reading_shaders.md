...
![Image](/img/Tutorials/shaders/img/texscreen_demo1.png)
...
![Image](/img/Tutorials/shaders/img/texscreen_bbc.png)

With correct back-buffer copying, the two spheres blend correctly:

![Image](/img/Tutorials/shaders/img/texscreen_demo2.png)
