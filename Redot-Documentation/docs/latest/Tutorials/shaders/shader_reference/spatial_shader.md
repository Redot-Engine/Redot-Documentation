...
| **alpha_to_coverage** | Alpha antialiasing mode, see [here](https://github.com/redot-engine/redot-engine/pull/40364) for more. |
| **alpha_to_coverage_and_one** | Alpha antialiasing mode, see [here](https://github.com/redot-engine/redot-engine/pull/40364) for more. |
