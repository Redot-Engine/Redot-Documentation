...
[3D Lights and Shadows demo project](https://github.com/redot-engine/redot-demo-projects/tree/master/3d/lights_and_shadows).
...
![Image](/img/Tutorials/3d/img/light_params.png)
...
![Image](/img/Tutorials/3d/img/lights_and_shadows_blur.webp)
...
![Image](/img/Tutorials/3d/img/lights_and_shadows_acne.webp)
...
![Image](/img/Tutorials/3d/img/lights_and_shadows_peter_panning.webp)
...
![Image](/img/Tutorials/3d/img/light_directional.png)
...
![Image](/img/Tutorials/3d/img/lights_and_shadows_pssm_explained.webp)

With this, shadows become more detailed:

![Image](/img/Tutorials/3d/img/lights_and_shadows_directional_mode.webp)

To control PSSM, a number of parameters are exposed:

![Image](/img/Tutorials/3d/img/lights_and_shadows_directional_shadow_params.webp)
...
![Image](/img/Tutorials/3d/img/blend_splits.png)
...
![Image](/img/Tutorials/3d/img/light_omni.png)
...
![Image](/img/Tutorials/3d/img/lights_and_shadows_dual_parabolid_vs_cubemap.webp)
...
![Image](/img/Tutorials/3d/img/lights_and_shadows_omni_projector_example.webp)

![Image](/img/Tutorials/3d/img/lights_and_shadows_omni_projector.webp)
...
![Image](/img/Tutorials/3d/img/lights_and_shadows_spot_projector_example.webp)

![Image](/img/Tutorials/3d/img/lights_and_shadows_spot_projector.webp)
...
![Image](/img/Tutorials/3d/img/lights_and_shadows_shadow_quadrants.webp)

Each quadrant can be subdivided to allocate any number of shadow maps; the following is the default subdivision:

![Image](/img/Tutorials/3d/img/lights_and_shadows_shadow_quadrants2.webp)
...
![Image](/img/Tutorials/3d/img/lights_and_shadows_filter_quality.webp)
