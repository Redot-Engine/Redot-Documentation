...
![Image](/img/Tutorials/3d/img/spring_arm_position_length.webp)
...
![Image](/img/Tutorials/3d/img/spring_arm_shape.webp)
...
![Image](/img/Tutorials/3d/img/spring_arm_children.webp)
...
![Image](/img/Tutorials/3d/img/spring_arm_camera_shape.webp)
...
![Image](/img/Tutorials/3d/img/spring_arm_camera_motion_cast.webp)

When the shape hits something, the camera will be placed at or near the collision point:

![Image](/img/Tutorials/3d/img/spring_arm_camera_collision.webp)
...
![Image](/img/Tutorials/3d/img/spring_arm_editor_setup.webp)

Let's move the pivot point up by ``2`` on the Y-axis so that it's not on the ground:

![Image](/img/Tutorials/3d/img/spring_arm_pivot_setup.webp)

Give the spring arm a length of ``3`` so that it is placed behind the character:

![Image](/img/Tutorials/3d/img/spring_arm_length_setup.webp)
