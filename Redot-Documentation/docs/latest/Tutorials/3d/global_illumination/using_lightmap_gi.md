...
![Image](/img/Tutorials/3d/global_illumination/img/gi_none.webp)

   LightmapGI disabled.

![Image](/img/Tutorials/3d/global_illumination/img/gi_lightmap_gi_indirect_only.webp)
...
![Image](/img/Tutorials/3d/global_illumination/img/gi_lightmap_gi_direct_and_indirect.webp)
...
![Image](/img/Tutorials/3d/global_illumination/img/lightmap_gi_comparison.png)
...
![Image](/img/Tutorials/3d/global_illumination/img/lightmap_gi_import.webp)

The **Meshes &gt; Light Baking** option must be set to **Static Lightmaps (VoxelGI/SDFGI/LightmapGI)**:

![Image](/img/Tutorials/3d/global_illumination/img/lightmap_gi_mesh_import_meshes.webp)
...
![Image](/img/Tutorials/3d/global_illumination/img/lightmap_gi_mesh_menu.webp)
...
![Image](/img/Tutorials/3d/global_illumination/img/lightmap_gi_blender.webp)

Then import the 3D scene normally. Remember you will need to set the texture
size on the mesh after import.

![Image](/img/Tutorials/3d/global_illumination/img/lightmap_gi_lmsize.webp)
...
![Image](/img/Tutorials/3d/global_illumination/img/lightmap_gi_uvchannel.webp)
...
![Image](/img/Tutorials/3d/global_illumination/img/lightmap_gi_scene.webp)
...
![Image](/img/Tutorials/3d/global_illumination/img/lightmap_gi_use.webp)
...
![Image](/img/Tutorials/3d/global_illumination/img/lightmap_gi_bake_mode.webp)
...
![Image](/img/Tutorials/3d/global_illumination/img/lightmap_gi_omnilight_size.png)
...
![Image](/img/Tutorials/3d/global_illumination/img/lightmap_gi_bake.webp)
...
![Image](/img/Tutorials/3d/global_illumination/img/lightmap_gi_shadowmask.webp)
...
![Image](/img/Tutorials/3d/global_illumination/img/lightmap_gi_denoiser_comparison.webp)
...
![Image](/img/Tutorials/3d/global_illumination/img/lightmap_gi_denoiser_jnlm_strength.webp)
...
![Image](/img/Tutorials/3d/global_illumination/img/lightmap_gi_denoiser_jnlm_vs_oidn.webp)
