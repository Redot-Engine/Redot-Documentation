...
![Image](/img/Tutorials/animation/img/tuto_cutout_walk.gif)
...
![Image](/img/Tutorials/animation/img/tuto_cutout1.png)
...
![Image](/img/Tutorials/animation/img/tuto_cutout2.png)
...
![Image](/img/Tutorials/animation/img/tuto_cutout3.png)
...
![Image](/img/Tutorials/animation/img/tutovec_torso1.gif)
...
![Image](/img/Tutorials/animation/img/tuto_cutout4.png)
...
![Image](/img/Tutorials/animation/img/tuto_cutout5.png)
...
![Image](/img/Tutorials/animation/img/tutovec_torso2.gif)
...
![Image](/img/Tutorials/animation/img/tuto_cutout6.png)

With the left arm there's a problem. In 2D, child nodes appear in front of
their parents:

![Image](/img/Tutorials/animation/img/tuto_cutout7.png)
...
![Image](/img/Tutorials/animation/img/tuto_cutout9.png)
...
![Image](/img/Tutorials/animation/img/tutovec_torso4.gif)
...
![Image](/img/Tutorials/animation/img/tuto_cutout10.png)
...
![Image](/img/Tutorials/animation/img/tuto_cutout11.png)

Then, click on the Skeleton menu and select ``Make Bones``.

![Image](/img/Tutorials/animation/img/tuto_cutout12.png)

This will add bones covering the arm, but the result may be surprising.

![Image](/img/Tutorials/animation/img/tuto_cutout13.png)
...
![Image](/img/Tutorials/animation/img/tuto_cutout14.png)

Now select the whole chain, from the endpoint to the arm and create
bones:

![Image](/img/Tutorials/animation/img/tuto_cutout15.png)
...
![Image](/img/Tutorials/animation/img/tuto_cutout15_2.png)

Your final skeleton should look something like this:

![Image](/img/Tutorials/animation/img/tuto_cutout16.png)
...
![Image](/img/Tutorials/animation/img/tuto_cutout17.png)

Then enable this chain for IK. Go to Edit &gt; Make IK Chain.

![Image](/img/Tutorials/animation/img/tuto_cutout18.png)

As a result, the base of the chain will turn *Yellow*.

![Image](/img/Tutorials/animation/img/tuto_cutout19.png)
...
![Image](/img/Tutorials/animation/img/tutovec_torso5.gif)
...
![Image](/img/Tutorials/animation/img/tuto_cutout20.png)
...
![Image](/img/Tutorials/animation/img/tuto_cutout21.png)
...
![Image](/img/Tutorials/animation/img/tuto_cutout22.png)
...
![Image](/img/Tutorials/animation/img/tuto_cutout23.png)
...
![Image](/img/Tutorials/animation/img/tuto_cutout24.png)
