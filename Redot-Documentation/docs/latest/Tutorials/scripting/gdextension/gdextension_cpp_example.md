...
repository [on GitHub ](https://github.com/redot-engine/redot-cpp).
...
![Image](/img/Tutorials/scripting/gdextension/img/gdextension_cpp_nodes.webp)

We're going to assign the Redot logo to this node as our texture, disable the
``centered`` property:

![Image](/img/Tutorials/scripting/gdextension/img/gdextension_cpp_sprite.webp)

We're finally ready to run the project:

![Image](/img/Tutorials/scripting/gdextension/img/gdextension_cpp_animated.gif)
