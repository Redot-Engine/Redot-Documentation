...
![Image](/img/Tutorials/export/img/icon_taskbar_icon.png)
...
![Image](/img/Tutorials/export/img/icon_project_settings.png)
...
external tools using [Redoticon ](https://github.com/pkowal1982/godoticon).
Changing the file icon this way should work for executables containing
an embedded PCK.

:::warning

There are [known issues ](https://github.com/redot-engine/redot-engine/issues/33466)
...
![Image](/img/Tutorials/export/img/icon_file_icon.png)
...
![Image](/img/Tutorials/export/img/icon_rcedit.png)
...
![Image](/img/Tutorials/export/img/icon_export_settings.png)
...
[platform/windows/Godot.ico ](https://github.com/redot-engine/redot-engine/blob/master/platform/windows/Godot.ico)
...
![Image](/img/Tutorials/export/img/icon_result.png)
