...
![Image](/img/Tutorials/physics/img/softbody_cube.png)
...
![Image](/img/Tutorials/physics/img/softbody_cube_menu.png)
...
:::note
You can download the Platformer3D demo on [GitHub](https://github.com/redot-engine/redot-demo-projects/tree/master/3d/platformer) or [the Asset Library](https://godotengine.org/asset-library/asset/2748).
...
![Image](/img/Tutorials/physics/img/softbody_cloak_subdivide.png)
...
![Image](/img/Tutorials/physics/img/softbody_cloak_bone_attach.png)

To create pinned joints, select the upper vertices in the ``SoftBody`` node:

![Image](/img/Tutorials/physics/img/softbody_cloak_pinned.png)
...
![Image](/img/Tutorials/physics/img/softbody_cloak_pinned_attach.png)

Last step is to avoid clipping by adding the Kinematic Body `Player` to ``Parent Collision Ignore`` of the ``SoftBody``.

![Image](/img/Tutorials/physics/img/softbody_cloak_ignore.png)

Play the scene and the cloak should simulate correctly.

![Image](/img/Tutorials/physics/img/softbody_cloak_finish.png)
