...
![Image](/img/GettingStarted/first_2d_game/img/add_script_button.webp)
...
![Image](/img/GettingStarted/first_2d_game/img/attach_node_window.webp)

:::note
If this is your first time encountering GDScript, please read
[doc_scripting](/en/latest/Getting%20Started/step_by_step/scripting_languages) before continuing.
...
![Image](/img/GettingStarted/first_2d_game/img/build_dotnet.webp)

:::

![Image](/img/GettingStarted/first_2d_game/img/export_variable.webp)
...
![Image](/img/GettingStarted/first_2d_game/img/input-mapping-add-action.webp)

We need to assign a key to this action. Click the "+" icon on the right, to
open the event manager window.

![Image](/img/GettingStarted/first_2d_game/img/input-mapping-add-key.webp)
...
![Image](/img/GettingStarted/first_2d_game/img/input-mapping-event-configuration.webp)
...
![Image](/img/GettingStarted/first_2d_game/img/input-mapping-completed.webp)
...
see an explanation of vector usage in Redot at [doc_vector_math](/en/latest/Tutorials/math/vector_math).
...
![Image](/img/GettingStarted/first_2d_game/img/player_signals.webp)
...
![Image](/img/GettingStarted/first_2d_game/img/player_signal_connection.webp)
