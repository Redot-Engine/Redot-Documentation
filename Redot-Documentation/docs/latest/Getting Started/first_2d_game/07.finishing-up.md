...
![Image](/img/GettingStarted/first_2d_game/img/unique_resource_music.webp)
...
![Image](/img/GettingStarted/first_2d_game/img/input-mapping-start_game.webp)
...
![Image](/img/GettingStarted/first_2d_game/img/start_button_shortcut.webp)

Create a new [InputEventAction](class_InputEventAction) and name it ``start_game``.

![Image](/img/GettingStarted/first_2d_game/img/start_button_shortcut2.webp)
...
And when you're ready, you can move on to [doc_your_first_3d_game](/en/latest/Getting%20Started/first_3d_game/index) to learn
...
playable on. See [doc_exporting_projects](/en/latest/Tutorials/export/exporting_projects) for instructions.
