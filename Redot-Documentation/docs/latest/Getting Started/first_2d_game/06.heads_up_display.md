...
UI, we'll use two types of [Control](class_Control) nodes: [Label](class_Label) and [Button](class_Button).
...
![Image](/img/GettingStarted/first_2d_game/img/custom_font_load_font.webp)
...
![Image](/img/GettingStarted/first_2d_game/img/custom_font_size.webp)
...
![Image](/img/GettingStarted/first_2d_game/img/ui_anchor.webp)
...
![Image](/img/GettingStarted/first_2d_game/img/completed_main_scene.webp)
...
![Image](/img/GettingStarted/first_2d_game/img/group_tab.webp)

Name the group ``mobs`` and click "ok" to add a new scene group.

![Image](/img/GettingStarted/first_2d_game/img/add_group_dialog.webp)

Now all mobs will be in the "mobs" group.

![Image](/img/GettingStarted/first_2d_game/img/scene_group_mobs.webp)
