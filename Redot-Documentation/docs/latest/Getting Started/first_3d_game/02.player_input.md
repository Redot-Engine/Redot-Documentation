...
![Image](/img/GettingStarted/first_3d_game/img/02.player_input/01.new_scene.png)

 Create a [CharacterBody3D](class_CharacterBody3D) node as the root

![Image](/img/GettingStarted/first_3d_game/img/02.player_input/add_character_body3D.webp)
...
[doc_physics_introduction](/en/latest/Tutorials/physics/physics_introduction).
...
![Image](/img/GettingStarted/first_3d_game/img/02.player_input/adding_node3D.webp)

Then, in the FileSystem dock, expand the ``art/`` folder
by double-clicking it and drag and
drop ``player.glb`` onto ``Pivot``.

![Image](/img/GettingStarted/first_3d_game/img/02.player_input/02.instantiating_the_model.webp)

This should instantiate the model as a child of ``Pivot``.
You can rename it to ``Character``.

![Image](/img/GettingStarted/first_3d_game/img/02.player_input/03.scene_structure.png)
...
![Image](/img/GettingStarted/first_3d_game/img/02.player_input/add_capsuleshape3d.webp)

The sphere's wireframe appears below the character.

![Image](/img/GettingStarted/first_3d_game/img/02.player_input/04.sphere_shape.png)
...
![Image](/img/GettingStarted/first_3d_game/img/02.player_input/05.moving_the_sphere_up.png)
...
![Image](/img/GettingStarted/first_3d_game/img/02.player_input/06.toggling_visibility.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/02.player_input/07.project_settings.png)
...
![Image](/img/GettingStarted/first_3d_game/img/02.player_input/07.input_map_tab.png)
...
![Image](/img/GettingStarted/first_3d_game/img/02.player_input/07.adding_action.webp)

Create the following five actions:

![Image](/img/GettingStarted/first_3d_game/img/02.player_input/08.actions_list_empty.png)
...
![Image](/img/GettingStarted/first_3d_game/img/02.player_input/left_inputmap.webp)

Bind also the `A` key, onto the action ``move_left``.

![Image](/img/GettingStarted/first_3d_game/img/02.player_input/09.keyboard_keys.png)
...
![Image](/img/GettingStarted/first_3d_game/img/02.player_input/joystick_axis_input.webp)

Select the negative X axis of the left joystick.

![Image](/img/GettingStarted/first_3d_game/img/02.player_input/left_joystick_select.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/02.player_input/12.move_inputs_mapped.webp)

The final action to set up is the ``jump`` action. Bind the Space key and the gamepad's
A button.

![Image](/img/GettingStarted/first_3d_game/img/02.player_input/13.joy_button_option.webp)

Your jump input action should look like this.

![Image](/img/GettingStarted/first_3d_game/img/02.player_input/14.jump_input_action.webp)
