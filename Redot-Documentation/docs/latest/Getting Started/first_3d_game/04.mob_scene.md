...
![Image](/img/GettingStarted/first_3d_game/img/04.mob_scene/drag_drop_mob.webp)

You can rename the newly created ``mob`` node
into ``Character``.

![Image](/img/GettingStarted/first_3d_game/img/04.mob_scene/01.initial_three_nodes.png)

We need a collision shape for our body to work. Right-click on the ``Mob`` node,
the scene's root, and click *Add Child Node*.

![Image](/img/GettingStarted/first_3d_game/img/04.mob_scene/02.add_child_node.png)

Add a [CollisionShape3D](class_CollisionShape3D).

![Image](/img/GettingStarted/first_3d_game/img/04.mob_scene/03.scene_with_collision_shape.png)

In the *Inspector*, assign a *BoxShape3D* to the *Shape* property.

![Image](/img/GettingStarted/first_3d_game/img/01.game_setup/08.create_box_shape3D.jpg)
...
![Image](/img/GettingStarted/first_3d_game/img/04.mob_scene/05.box_final_size.png)
...
about that here: [doc_gdscript_basics_memory_management](/en/latest/Tutorials/scripting/gdscript/gdscript_basics).
...
![Image](/img/GettingStarted/first_3d_game/img/04.mob_scene/06.visibility_notifier.png)

Resize it using the orange dots until it covers the entire 3D model.

![Image](/img/GettingStarted/first_3d_game/img/04.mob_scene/07.visibility_notifier_bbox_resized.png)
...
![Image](/img/GettingStarted/first_3d_game/img/04.mob_scene/08.mob_attach_script.png)
...
![Image](/img/GettingStarted/first_3d_game/img/04.mob_scene/09.switch_to_3d_workspace.png)
...
![Image](/img/GettingStarted/first_3d_game/img/04.mob_scene/10.node_dock.webp)

Connect the signal to the ``Mob``

![Image](/img/GettingStarted/first_3d_game/img/04.mob_scene/11.connect_signal.webp)
