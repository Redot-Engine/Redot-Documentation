...
1. Read the [Scripting section](/en/latest/Tutorials/scripting/index) to learn essential programming features you'll use
   in every project.
2. The [3D](/en/latest/Tutorials/3d/index) and [Physics](/en/latest/Tutorials/physics/index) sections will teach you more about 3D game creation in the
   engine.
3. [Inputs](/en/latest/Tutorials/inputs/index) is another important one for any game project.
