...
![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/01_label_node.webp)

In the *Inspector*, set the *Label*'s *Text* to a placeholder like "Score: 0".

![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/02_score_placeholder.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/03_score_font_color.webp)

Finally, click and drag on the text in the viewport to move it away from the
top-left corner.

![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/04_score_label_moved.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/05_creating_theme.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/06_theme_preview.webp)
...
creating and editing themes, see [doc_gui_skinning](/en/latest/Tutorials/ui/gui_skinning).
...
![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/07_font_size.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/08_open_main_script.webp)
...
You can learn more about string formatting here: [doc_gdscript_printf](/en/latest/Tutorials/scripting/gdscript/gdscript_format_string).
...
![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/09_score_in_game.png)
...
![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/10_anchor_preset.webp)

Open it and apply the *Full Rect* command.

![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/11_full_rect_option.webp)

Nothing happens. Well, almost nothing; only the four green pins move to the
corners of the selection box.

![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/12_anchors_updated.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/13_retry_color_picker.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/14_center_option.webp)
...
another feature in Redot: [autoloads](/en/latest/Tutorials/scripting/singletons_autoload).
...
![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/15_new_scene.webp)

Click the *Other Node* button to create an [AudioStreamPlayer](class_AudioStreamPlayer) and rename it to
``MusicPlayer``.

![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/16_music_player_node.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/17_music_node_properties.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/18_register_autoload.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/19_scene_dock_tabs.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/08.score_and_replay/20_remote_scene_tree.webp)
