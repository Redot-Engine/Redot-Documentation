...
![Image](/img/GettingStarted/first_3d_game/img/03.player_movement_code/01.attach_script_to_player.webp)
...
``_physics_process()``, see [doc_idle_and_physics_processing](/en/latest/Tutorials/scripting/idle_and_physics_processing).
...
![Image](/img/GettingStarted/first_3d_game/img/03.player_movement_code/02.clicking_main_tab.png)
...
![Image](/img/GettingStarted/first_3d_game/img/03.player_movement_code/03.instance_child_scene.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/03.player_movement_code/04.scene_tree_with_camera.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/03.player_movement_code/05.camera_preview_checkbox.png)
...
![Image](/img/GettingStarted/first_3d_game/img/03.player_movement_code/12.viewport_change.webp)

![Image](/img/GettingStarted/first_3d_game/img/03.player_movement_code/06.two_viewports.png)

On the bottom view, select your [Camera3D](class_Camera3D) and turn on camera
Preview by clicking the checkbox.

![Image](/img/GettingStarted/first_3d_game/img/03.player_movement_code/07.camera_preview_checkbox.png)

In the top view, make sure your *Camera3D* is selected and move the camera about
``19`` units on the Z axis (drag the blue arrow).

![Image](/img/GettingStarted/first_3d_game/img/03.player_movement_code/08.camera_moved.png)
...
![Image](/img/GettingStarted/first_3d_game/img/03.player_movement_code/09.camera_rotated.png)

You can run the scene by pressing `F6` and press the arrow keys to move the
character.

![Image](/img/GettingStarted/first_3d_game/img/03.player_movement_code/10.camera_perspective.png)
...
![Image](/img/GettingStarted/first_3d_game/img/03.player_movement_code/13.camera3d_values.webp)
