...
![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/animation_player_dock.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/02.new_animation.webp)

Name the animation "float".

![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/03.float_name.png)

Once you've created the animation, the timeline appears with numbers representing
time in seconds.

![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/03.timeline.png)

We want the animation to start playback automatically at the start of the game.
Also, it should loop.

To do so, you can click the autoplay button (![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/autoplay_button.webp)) in the animation toolbar
and the looping arrows, respectively.

![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/04.autoplay_and_loop.png)
...
![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/05.pin_icon.png)

Set the animation duration to ``1.2`` seconds in the top-right of the dock.

![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/06.animation_duration.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/07.editable_timeline.webp)

You can click and drag the slider in the bottom-right to zoom in and out of the
timeline.

![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/08.zoom_slider.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/09.creating_first_keyframe.webp)

![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/curves.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/10.initial_keys.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/11.moving_keys.webp)

Move the time cursor to ``0.5`` seconds by clicking and dragging on the gray
timeline.

![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/timeline_05_click.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/12.second_keys_values.webp)

Create a keyframe for both properties

![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/second_keys_both.webp)

Now, move the position keyframe to ``0.7``
seconds by dragging it on the timeline.

![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/13.second_keys.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/animation_final_keyframes.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/14.play_button.png)
...
![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/15.box_select.webp)

You can edit the properties of both keys simultaneously in the *Inspector*,
where you can see an *Easing* property.

![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/16.easing_property.png)
...
![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/17.ease_out.png)
...
![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/18.ease_out_second_rotation_key.png)

Do the opposite for the second position keyframe, dragging it to the right.

![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/19.ease_in_second_translation_key.png)

Your animation should look something like this.

![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/20.float_animation.gif)
...
![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/21.script_icon.png)
...
Next, make sure that the autoplay button (![Image](/img/GettingStarted/first_3d_game/img/09.adding_animations/autoplay_button.webp)) and the looping
