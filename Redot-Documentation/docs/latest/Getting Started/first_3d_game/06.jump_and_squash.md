...
![Image](/img/GettingStarted/first_3d_game/img/06.jump_and_squash/02.project_settings.png)
...
![Image](/img/GettingStarted/first_3d_game/img/06.jump_and_squash/03.physics_layers.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/06.jump_and_squash/04.default_physics_properties.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/06.jump_and_squash/05.toggle_layer_and_mask.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/06.jump_and_squash/06.named_checkboxes.png)
...
![Image](/img/GettingStarted/first_3d_game/img/06.jump_and_squash/07.player_physics_mask.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/06.jump_and_squash/08.mob_physics_mask.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/06.jump_and_squash/09.groups_tab.png)

An icon appears in the *Scene* dock to indicate the node is part of at least one
group.

![Image](/img/GettingStarted/first_3d_game/img/06.jump_and_squash/10.group_scene_icon.png)
...
When using C#, Redot will create the appropriate events automatically for all Signals ending with `EventHandler`, see [C# Signals](/en/latest/Tutorials/scripting/c_sharp/c_sharp_signals).
