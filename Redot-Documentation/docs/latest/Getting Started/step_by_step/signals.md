...
([doc_scripting_player_input](/en/latest/Getting%20Started/step_by_step/scripting_player_input)) move and stop by pressing a button.

:::note
For this project, we will be following the Redot naming conventions.
- **GDScript**: Classes (nodes) use PascalCase, variables and
  functions use snake_case, and constants use ALL_CAPS (See
  [doc_gdscript_styleguide](/en/latest/Tutorials/scripting/gdscript/gdscript_styleguide)).

- **C#**: Classes, export variables and methods use PascalCase,
  private fields use _camelCase, local variables and parameters use
  camelCase (See [doc_c_sharp_styleguide](/en/latest/Tutorials/scripting/c_sharp/c_sharp_style_guide)). Be careful to type
...
the [doc_scripting_first_script](/en/latest/Getting%20Started/step_by_step/scripting_first_script) lesson.

Create a new scene by going to the menu Scene -&gt; New Scene.

![Image](/img/GettingStarted/step_by_step/img/signals_01_new_scene.webp)

In the Scene dock, click the 2D Scene button. This will add
a [Node2D](class_Node2D) as our root.

![Image](/img/GettingStarted/step_by_step/img/signals_02_2d_scene.webp)

In the FileSystem dock, click and drag the ``sprite_2d.tscn`` file you saved
previously onto the Node2D to instantiate it.

![Image](/img/GettingStarted/step_by_step/img/signals_03_dragging_scene.png)

We want to add another node as a sibling of the Sprite2D. To do so, right-click
on Node2D and select Add Child Node.

![Image](/img/GettingStarted/step_by_step/img/signals_04_add_child_node.webp)

Search for the [Button](class_Button) node and add it.

![Image](/img/GettingStarted/step_by_step/img/signals_05_add_button.webp)

The node is small by default. Click and drag on the bottom-right handle of the
Button in the viewport to resize it.

![Image](/img/GettingStarted/step_by_step/img/signals_06_drag_button.png)

If you don't see the handles, ensure the select tool is active in the toolbar.

![Image](/img/GettingStarted/step_by_step/img/signals_07_select_tool.webp)
...
![Image](/img/GettingStarted/step_by_step/img/signals_08_toggle_motion_text.webp)

Your scene tree and viewport should look like this.

![Image](/img/GettingStarted/step_by_step/img/signals_09_scene_setup.png)
...
![Image](/img/GettingStarted/step_by_step/img/signals_10_node_dock.webp)

The dock displays a list of signals available on the selected node.

![Image](/img/GettingStarted/step_by_step/img/signals_11_pressed_signals.webp)

Double-click the "pressed" signal to open the node connection window.

![Image](/img/GettingStarted/step_by_step/img/signals_12_node_connection.webp)
...
![Image](/img/GettingStarted/step_by_step/img/signals_advanced_connection_window.png)
...
![Image](/img/GettingStarted/step_by_step/img/signals_13_signals_connection_icon.webp)
...
![Image](/img/GettingStarted/step_by_step/img/signals_14_signals_connection_info.webp)
...
![Image](/img/GettingStarted/step_by_step/img/signals_15_scene_tree.png)

With the Timer node selected, go to the Inspector and enable the **Autostart**
property.

![Image](/img/GettingStarted/step_by_step/img/signals_18_timer_autostart.png)

Click the script icon next to Sprite2D to jump back to the scripting workspace.

![Image](/img/GettingStarted/step_by_step/img/signals_16_click_script.png)
...
![Image](/img/GettingStarted/step_by_step/img/signals_17_custom_signal.webp)
...
In the next section, [doc_your_first_2d_game](/en/latest/Getting%20Started/first_2d_game/index), you'll create a complete 2D
