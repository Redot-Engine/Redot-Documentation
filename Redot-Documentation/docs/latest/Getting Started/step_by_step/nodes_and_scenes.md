...
In [doc_key_concepts_overview](/en/latest/Getting%20Started/introduction/key_concepts_overview), we saw that a Redot game is a tree of
...
![Image](/img/GettingStarted/step_by_step/img/nodes_and_scenes_nodes.webp)
...
![Image](/img/GettingStarted/step_by_step/img/nodes_and_scenes_character_nodes.webp)
...
![Image](/img/GettingStarted/step_by_step/img/nodes_and_scenes_3d_scene_example.png)
...
[create a new project](/en/latest/Tutorials/editor/project_manager) first. After
...
![Image](/img/GettingStarted/step_by_step/img/nodes_and_scenes_02_scene_dock.webp)

The Create Node dialog opens, showing the long list of available nodes.

![Image](/img/GettingStarted/step_by_step/img/nodes_and_scenes_03_create_node_window.webp)

Select the Label node. You can type its name to filter down the list.

![Image](/img/GettingStarted/step_by_step/img/nodes_and_scenes_04_create_label_window.webp)

Click on the Label node to select it and click the Create button at the bottom
of the window.

![Image](/img/GettingStarted/step_by_step/img/nodes_and_scenes_05_editor_with_label.webp)
...
![Image](/img/GettingStarted/step_by_step/img/nodes_and_scenes_06_label_text.webp)
...
[doc_editor_inspector_dock](/en/latest/Tutorials/editor/inspector_dock).
...
![Image](/img/GettingStarted/step_by_step/img/nodes_and_scenes_07_move_tool.webp)
...
![Image](/img/GettingStarted/step_by_step/img/nodes_and_scenes_08_hello_world_text.webp)
...
![Image](/img/GettingStarted/step_by_step/img/nodes_and_scenes_09_play_scene_button.webp)
...
![Image](/img/GettingStarted/step_by_step/img/nodes_and_scenes_10_save_scene_as.webp)
...
Redot, see [doc_filesystem](/en/latest/Tutorials/scripting/filesystem).

:::

The application should open in a new window and display the text "Hello World".

![Image](/img/GettingStarted/step_by_step/img/nodes_and_scenes_11_final_result.webp)
...
![Image](/img/GettingStarted/step_by_step/img/nodes_and_scenes_12_play_button.webp)

A popup window appears and invites you to select the main scene.

![Image](/img/GettingStarted/step_by_step/img/nodes_and_scenes_13_main_scene_popup.webp)

Click the Select button, and in the file dialog that appears, double click on
``label.tscn``.

![Image](/img/GettingStarted/step_by_step/img/nodes_and_scenes_14_select_main_scene.webp)
...
[doc_project_settings](/en/latest/Tutorials/editor/project_settings).
