...
work. You can read more on that here: [doc_consoles](/en/latest/Tutorials/platform/consoles).
...
![Image](/img/GettingStarted/introduction/img/introduction_ex_zodiac.png)

![Image](/img/GettingStarted/introduction/img/introduction_helms_of_fury.jpg)
...
![Image](/img/GettingStarted/introduction/img/introduction_rpg_in_a_box.png)
...
![Image](/img/GettingStarted/introduction/img/introduction_editor.webp)
...
![Image](/img/GettingStarted/introduction/img/introduction_vscode.png)

## Programming languages

Let's talk about the available programming languages.

You can code your games using [GDScript](/en/latest/Tutorials/scripting/gdscript/index), a
Redot-specific and tightly integrated language with a lightweight syntax, or
[C#](/en/latest/Tutorials/scripting/c_sharp/index), which is popular in the games industry.
...
[doc_learning_new_features](/en/latest/Getting%20Started/introduction/learning_new_features).
