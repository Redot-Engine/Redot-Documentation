...
There is a [Web editor ](https://editor.redotengine.org/) you can use to work
...
- No project exporting. As a workaround, you can download the project source
  ...
  [native version of the Redot editor ](https://redotengine.org/download).
...
See the
[list of open issues on GitHub related to the web editor ](https://github.com/redot-engine/redot-engine/issues?q=is%3Aopen+is%3Aissue+label%3Aplatform%3Aweb+label%3Atopic%3Aeditor)
...
project using a [native Redot editor ](https://redotengine.org/download),
