...
![Image](/img/Tutorials/xr/img/xr_shaders.png)
...
![Image](/img/Tutorials/xr/img/xr_basic_scene.png)

Next you need to configure the controllers, select the left hand and set it up as follows:

![Image](/img/Tutorials/xr/img/xr_left_hand.png)

And the right hand:

![Image](/img/Tutorials/xr/img/xr_right_hand.png)
