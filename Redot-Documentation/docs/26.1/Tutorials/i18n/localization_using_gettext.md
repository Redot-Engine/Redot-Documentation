...
In addition to [doc_importing_translations](doc_importing_translations#importing-translations) in CSV format, Redot
...
![Image](/img/Tutorials/i18n/img/localization_using_gettext_pot_generation.webp)
