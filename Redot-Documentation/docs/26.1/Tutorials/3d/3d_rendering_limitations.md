...
<figure>
  <img src="/img/Tutorials/3d/img/3d_rendering_limitations_banding.webp" alt="Color banding comparison (contrast increased for more visibility)" />
  <figcaption>
...
<figure>
  <img src="/img/Tutorials/3d/img/3d_rendering_limitations_z_fighting.webp" alt="Z-fighting comparison (before and after tweaking the scene by offsetting the Label3D away from the floor)" />
  <figcaption>
...
<figure>
  <img src="/img/Tutorials/3d/img/3d_rendering_limitations_transparency_sorting.webp" alt="Transparency sorting comparison (alpha-blended materials on the left, alpha scissor materials on the right)" />
  <figcaption>
