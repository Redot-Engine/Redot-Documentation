...
[TLS certificate bundle from Mozilla ](https://github.com/redot-engine/redot-engine/blob/master/thirdparty/certs/ca-certificates.crt)
as a fallback.

You can alternatively force your own certificate bundle in the Project Settings:

![Image](/img/Tutorials/networking/img/tls_certificates_project_setting.webp)
