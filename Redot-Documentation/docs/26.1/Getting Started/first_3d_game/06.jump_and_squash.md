...
the world of [physics layers](doc_physics_introduction#collision-layers-and-masks).
...
collisions with the floor. To do so, we can use Redot's [group](doc_groups) tagging feature.
