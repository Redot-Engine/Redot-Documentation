...
creating and editing themes, see [doc_gui_skinning](/en/26.1/Tutorials/ui/gui_skinning).
...
You can learn more about string formatting here: [doc_gdscript_printf](/en/26.1/Tutorials/scripting/gdscript/gdscript_format_string).
...
another feature in Redot: [autoloads](/en/26.1/Tutorials/scripting/singletons_autoload).
