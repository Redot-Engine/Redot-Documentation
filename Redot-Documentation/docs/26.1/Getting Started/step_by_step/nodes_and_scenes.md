...
In [doc_key_concepts_overview](/en/26.1/Getting%20Started/introduction/key_concepts_overview), we saw that a Redot game is a tree of
...
[create a new project](/en/26.1/Tutorials/editor/project_manager) first. After
...
[doc_editor_inspector_dock](/en/26.1/Tutorials/editor/inspector_dock).
...
Redot, see [doc_filesystem](/en/26.1/Tutorials/scripting/filesystem).
...
[doc_project_settings](/en/26.1/Tutorials/editor/project_settings).
