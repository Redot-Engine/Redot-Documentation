...
Building upon the previous lesson, [doc_scripting_first_script](/en/26.1/Getting%20Started/step_by_step/scripting_first_script), let's look
...
1. The built-in input callbacks, mainly ``_unhandled_input()``. Like
   ...
   more about input callbacks, see [doc_inputevent](/en/26.1/Tutorials/inputs/inputevent).
...
In the next lesson, [doc_signals](/en/26.1/Getting%20Started/step_by_step/signals), we'll build upon the relationship between
