...
the [GDScript reference](/en/26.1/Tutorials/scripting/gdscript/gdscript_basics).

:::

:::info
To learn more about C#, head to the [C# basics](/en/26.1/Tutorials/scripting/c_sharp/c_sharp_basics) page.

:::

## Project setup

Please [create a new project](/en/26.1/Tutorials/editor/project_manager) to
...
walls or the floor. In [doc_your_first_2d_game](/en/26.1/Getting%20Started/first_2d_game/index), you will learn
another approach to moving objects while detecting collisions.

:::

Our node currently moves by itself. In the next part,
[doc_scripting_player_input](/en/26.1/Getting%20Started/step_by_step/scripting_player_input), we'll use player input to control it.
