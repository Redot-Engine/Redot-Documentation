...
from Godot for detailed information.
...
The [BoneAttachment3D](class_BoneAttachment3D) node is an intermediate node to describe some
...
An example of a [Marker3D](class_Marker3D) node parented to a bone in Skeleton:
