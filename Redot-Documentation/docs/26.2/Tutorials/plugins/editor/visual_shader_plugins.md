...
![Image](/img/Tutorials/plugins/editor/img/visual_shader_plugins_start.png)

Assign [class_VisualShader](class_VisualShader) to the shader slot of the material:

![Image](/img/Tutorials/plugins/editor/img/visual_shader_plugins_start2.png)

Don't forget to change its mode to "CanvasItem" (if you are using a Sprite2D):

![Image](/img/Tutorials/plugins/editor/img/visual_shader_plugins_start3.png)
...
![Image](/img/Tutorials/plugins/editor/img/visual_shader_plugins_result1.png)

Place it on a graph and connect the required ports:

![Image](/img/Tutorials/plugins/editor/img/visual_shader_plugins_result2.png)
