...
![Image](/img/Tutorials/scripting/img/nodes_resources.webp)
...
![Image](/img/Tutorials/scripting/img/spriteprop.webp)

Clicking the resource preview allows us to view the resource's properties.

![Image](/img/Tutorials/scripting/img/resourcerobi.webp)
...
If the script's language supports [script classes ](doc_gdscript_basics#registering-named-classes),
