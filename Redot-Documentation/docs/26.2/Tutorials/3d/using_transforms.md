...
![Image](/img/Tutorials/3d/img/transforms_euler.png)

Euler angles were introduced by mathematician Leonhard Euler in the early 1700s.

![Image](/img/Tutorials/3d/img/transforms_euler_himself.png)
...
![Image](/img/Tutorials/3d/img/transforms_gimbal.gif)
...
![Image](/img/Tutorials/3d/img/transforms_rotate1.gif)

If we were to apply rotation in the *X* axis first, and then in *Y*, the effect would be undesired:

![Image](/img/Tutorials/3d/img/transforms_rotate2.gif)
...
![Image](/img/Tutorials/3d/img/transforms_interpolate1.gif)

But this does not always have the expected effect when using angles:

![Image](/img/Tutorials/3d/img/transforms_interpolate2.gif)
...
![Image](/img/Tutorials/3d/img/transforms_camera.png)

One way to visualize a transform is to look at an object's 3D gizmo while in "local space" mode.

![Image](/img/Tutorials/3d/img/transforms_local_space.png)
...
![Image](/img/Tutorials/3d/img/transforms_gizmo.png)
