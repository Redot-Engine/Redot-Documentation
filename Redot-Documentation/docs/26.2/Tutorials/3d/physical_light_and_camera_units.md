...
<figure>
  <img src="/img/Tutorials/3d/img/physical_light_units_color_temperature_chart.webp" alt="Color temperature chart from 1,000 Kelvin (left) to 12,500 Kelvin (right)" />
  <figcaption>
