...
![Image](/img/Tutorials/3d/img/environment_camera.webp)
...
![Image](/img/Tutorials/3d/img/environment_world.webp)
...
![Image](/img/Tutorials/3d/img/environment_preview_sun_sky_toggle.webp)
...
![Image](/img/Tutorials/3d/img/environment_preview_sun_sky_dialog.webp)
...
![Image](/img/Tutorials/3d/img/environment_background1.webp)
...
![Image](/img/Tutorials/3d/img/environment_ambient.webp)
...
![Image](/img/Tutorials/3d/img/environment_ambient2.webp)
...
![Image](/img/Tutorials/3d/img/environment_ambient_comparison.webp)
...
![Image](/img/Tutorials/3d/img/environment_fog_depth_height.webp)
...
![Image](/img/Tutorials/3d/img/environment_fog_transmission.webp)
...
![Image](/img/Tutorials/3d/img/environment_ssr.webp)
...
![Image](/img/Tutorials/3d/img/environment_ssao.webp)
...
![Image](/img/Tutorials/3d/img/environment_ssao2.webp)

Tweaking :abbr:`SSAO (Screen-Space Ambient Occlusion)` is possible with several
parameters:

![Image](/img/Tutorials/3d/img/environment_ssao_parameters.webp)
...
![Image](/img/Tutorials/3d/img/environment_ssil.webp)
...
![Image](/img/Tutorials/3d/img/environment_sdfgi.webp)
...
![Image](/img/Tutorials/3d/img/environment_glow1.webp)
...
![Image](/img/Tutorials/3d/img/environment_glow_threshold.webp)
...
![Image](/img/Tutorials/3d/img/environment_glow_bloom.webp)
...
![Image](/img/Tutorials/3d/img/environment_glow_layers.webp)

The real strength of this system, though, is to combine levels to create more
interesting glow patterns:

![Image](/img/Tutorials/3d/img/environment_glow_layers2.webp)
...
![Image](/img/Tutorials/3d/img/environment_glow_map.webp)
...
<figure>
  <img src="/img/Tutorials/3d/img/environment_and_post_processing_glow_in_2d.webp" alt="Example of using glow in a 2D scene" />
  <figcaption>
...
<figure>
  <img src="/img/Tutorials/3d/img/environment_and_post_processing_glow_blur.webp" alt="Example of using glow to blur the 2D rendering in the menu's background" />
  <figcaption>
...
![Image](/img/Tutorials/3d/img/environment_adjustments.webp)
...
![Image](/img/Tutorials/3d/img/environment_adjustments_bcs.webp)
...
![Image](/img/Tutorials/3d/img/environment_adjustments_default_gradient.webp)

But creating custom ones will allow to map each channel to a different color:

![Image](/img/Tutorials/3d/img/environment_adjustments_custom_gradient.webp)
...
![Image](/img/Tutorials/3d/img/environment_adjustments_3d_lut_import.webp)
...
![Image](/img/Tutorials/3d/img/environment_adjustments_3d_lut_template.webp)
...
![Image](/img/Tutorials/3d/img/environment_adjustments_3d_lut_comparison.webp)
...
![Image](/img/Tutorials/3d/img/environment_dof_far.webp)
...
![Image](/img/Tutorials/3d/img/environment_dof_near.webp)
...
![Image](/img/Tutorials/3d/img/environment_mixed_blur.webp)
...
![Image](/img/Tutorials/3d/img/environment_hdr_autoexp.webp)
...
![Image](/img/Tutorials/3d/img/environment_hdr.webp)
