...
residential connections use a [NAT](https://en.wikipedia.org/wiki/Network_address_translation). Redot's
...
See further explanation and troubleshooting on [this post ](https://github.com/redot-engine/redot-engine/issues/57869#issuecomment-1034215138).
