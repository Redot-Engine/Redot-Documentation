...
- FBX, supported via the [ufbx ](https://github.com/ufbx/ufbx) library. The
  previous import workflow used [FBX2glTF ](https://github.com/redot-engine/FBX2glTF)
...
![Image](/img/Tutorials/assets_pipeline/importing_3d_scenes/img/importing_3d_scenes_available_formats_gltf_runtime.webp)
...
![Image](/img/Tutorials/assets_pipeline/importing_3d_scenes/img/importing_3d_scenes_available_formats_gltf_editor.webp)
...
calling [Blender ](https://www.blender.org/)'s glTF export functionality in a
transparent manner.
...
![Image](/img/Tutorials/assets_pipeline/importing_3d_scenes/img/importing_3d_scenes_available_formats_blend.webp)
...
unless you have a specific reason to use it, you need to download the [FBX2glTF ](https://github.com/redot-engine/FBX2glTF)
...
![Image](/img/Tutorials/assets_pipeline/importing_3d_scenes/img/importing_3d_scenes_available_formats_fbx.webp)

:::info

The full installation process for using FBX2glTF in Redot is described on the
[FBX import page of the Redot website ](https://redotengine.org/fbx-import).
