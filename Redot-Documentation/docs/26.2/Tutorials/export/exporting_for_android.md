...
Download and install [OpenJDK 17 ](https://adoptium.net/temurin/releases/?variant=openjdk17).
...
![Image](/img/Tutorials/export/img/editorsettings.png)

Scroll down to the section where the Android settings are located:

![Image](/img/Tutorials/export/img/android_editor_settings.webp)
...
![Image](/img/Tutorials/export/img/editor-export-presets-android.png)
...
![Image](/img/Tutorials/export/img/export-with-debug-button.png)
