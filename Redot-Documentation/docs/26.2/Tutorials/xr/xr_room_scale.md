...
![Image](/img/Tutorials/xr/img/XRRoomCenterWalk.gif)
...
![Image](/img/Tutorials/xr/img/XRRoomWalkOffCliff.gif)
...
![Image](/img/Tutorials/xr/img/XRRoomRotateOrigin.gif)
...
![Image](/img/Tutorials/xr/img/XRRoomWalkWall.gif)
...
![Image](/img/Tutorials/xr/img/xr_room_scale_origin_body.webp)
...
The [Origin centric movement demo ](https://github.com/redot-engine/redot-demo-projects/tree/master/xr/openxr_origin_centric_movement) contains a more elaborate example of the technique described below.
...
![Image](/img/Tutorials/xr/img/xr_room_scale_character_body.webp)
...
The [Character centric movement demo ](https://github.com/redot-engine/redot-demo-projects/tree/master/xr/openxr_character_centric_movement) contains a more elaborate example of the technique described below.
