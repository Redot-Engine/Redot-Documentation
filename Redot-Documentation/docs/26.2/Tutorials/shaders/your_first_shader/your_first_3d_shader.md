...
![Image](/img/Tutorials/shaders/your_first_shader/img/plane.png)

Now set ``Subdivide Width`` and ``Subdivide Depth`` of the [PlaneMesh ](class_planemesh) to ``32``.

![Image](/img/Tutorials/shaders/your_first_shader/img/plane-sub-set.webp)
...
![Image](/img/Tutorials/shaders/your_first_shader/img/plane-sub.png)
...
![Image](/img/Tutorials/shaders/your_first_shader/img/shader-editor.webp)
...
![Image](/img/Tutorials/shaders/your_first_shader/img/cos.png)
...
![Image](/img/Tutorials/shaders/your_first_shader/img/cos4.png)
...
![Image](/img/Tutorials/shaders/your_first_shader/img/noise-set.webp)
...
![Image](/img/Tutorials/shaders/your_first_shader/img/noise.png)
...
![Image](/img/Tutorials/shaders/your_first_shader/img/noise-low.png)
...
![Image](/img/Tutorials/shaders/your_first_shader/img/normal.png)
...
![Image](/img/Tutorials/shaders/your_first_shader/img/light.png)
...
![Image](/img/Tutorials/shaders/your_first_shader/img/normal-set.webp)
...
![Image](/img/Tutorials/shaders/your_first_shader/img/normalmap.png)

We can even drag the light around and the lighting will update automatically.

![Image](/img/Tutorials/shaders/your_first_shader/img/normalmap2.png)
