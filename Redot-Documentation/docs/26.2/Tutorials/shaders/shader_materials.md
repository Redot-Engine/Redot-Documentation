...
![Image](/img/Tutorials/shaders/img/shader_material_create.png)
...
![Image](/img/Tutorials/shaders/img/shader_create.png)

If you create a regular shader click on it and the shader editor will open.

![Image](/img/Tutorials/shaders/img/shader_material_editor.png)

If you create a visual shader the visual shader editor will open automatically.

![Image](/img/Tutorials/shaders/img/visual_shader_editor.png)
...
![Image](/img/Tutorials/shaders/img/visual_shader_code.png)
...
![Image](/img/Tutorials/shaders/img/shader_material_convert.png)
