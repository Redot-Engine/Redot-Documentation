...
![Image](/img/Tutorials/shaders/img/shader_material_create_mesh.webp)

Then assign a [class_Shader](class_Shader) resource to the ``Shader`` property.

![Image](/img/Tutorials/shaders/img/visual_shader_create.webp)
...
![Image](/img/Tutorials/shaders/img/visual_shader_create2.webp)
...
![Image](/img/Tutorials/shaders/img/visual_shader_editor2.webp)
...
![Image](/img/Tutorials/shaders/img/vs_popup.webp)
...
![Image](/img/Tutorials/shaders/img/vs_node.webp)
...
![Image](/img/Tutorials/shaders/img/vs_expression2.png)
...
![Image](/img/Tutorials/shaders/img/vs_reroute.webp)

To move a reroute node move your mouse cursor above it, and grab the handle that
appears.

![Image](/img/Tutorials/shaders/img/vs_reroute_handle.webp)
...
![Image](/img/Tutorials/shaders/img/vs_fresnel.webp)
...
![Image](/img/Tutorials/shaders/img/vs_boolean.gif)
...
![Image](/img/Tutorials/shaders/img/vs_if.png)
...
![Image](/img/Tutorials/shaders/img/vs_switch.webp)