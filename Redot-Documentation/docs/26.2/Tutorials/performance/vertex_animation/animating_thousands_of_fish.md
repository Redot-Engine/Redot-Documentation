...
![Image](/img/Tutorials/performance/vertex_animation/img/fish.png)
...
![Image](/img/Tutorials/performance/vertex_animation/img/sidetoside.gif)
...
![Image](/img/Tutorials/performance/vertex_animation/img/pivot.gif)
...
![Image](/img/Tutorials/performance/vertex_animation/img/wave.gif)
...
![Image](/img/Tutorials/performance/vertex_animation/img/twist.gif)

If we apply all these motions one after another, we get a fluid jelly-like motion.

![Image](/img/Tutorials/performance/vertex_animation/img/all_motions.gif)
...
![Image](/img/Tutorials/performance/vertex_animation/img/mask.png)
...
![Image](/img/Tutorials/performance/vertex_animation/img/all_motions_mask.gif)
