...
The game we'll code here is similar to [doc_your_first_2d_game](/en/26.2/Getting%20Started/first_2d_game/index), with a twist:
...
- [Setting up the game area](/en/26.2/Getting%20Started/first_3d_game/01.game_setup)
- [Player scene and input actions](/en/26.2/Getting%20Started/first_3d_game/02.player_input)
- [Moving the player with code](/en/26.2/Getting%20Started/first_3d_game/03.player_movement_code)
- [Designing the mob scene](/en/26.2/Getting%20Started/first_3d_game/04.mob_scene)
- [Spawning monsters](/en/26.2/Getting%20Started/first_3d_game/05.spawning_mobs)
- [Jumping and squashing monsters](/en/26.2/Getting%20Started/first_3d_game/06.jump_and_squash)
- [Killing the player](/en/26.2/Getting%20Started/first_3d_game/07.killing_player)
- [Score and replay](/en/26.2/Getting%20Started/first_3d_game/08.score_and_replay)
- [Character animation](/en/26.2/Getting%20Started/first_3d_game/09.adding_animations)
- [Going further](/en/26.2/Getting%20Started/first_3d_game/going_further)
