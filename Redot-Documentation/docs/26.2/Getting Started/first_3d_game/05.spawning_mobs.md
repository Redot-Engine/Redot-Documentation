...
![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/01.monsters_path_preview.png)
...
![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/02.project_settings.png)
...
![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/03.window_settings.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/04.camera_preview.png)
...
![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/05.cylinders_node.png)

In the *Inspector*, assign a *CylinderMesh* to the *Mesh* property.

![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/06.cylinder_mesh.png)
...
![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/07.top_view.png)

The grid may be distracting. You can toggle it by going to the *View*
menu in the toolbar and clicking *View Grid*.

![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/08.toggle_view_grid.png)
...
![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/09.toggle_grid_snap.png)

Move the cylinder so it's right outside the camera's view in the top-left
corner.

![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/10.place_first_cylinder.png)
...
![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/11.both_cylinders_selected.png)

Move them to the right by dragging the red X axis.

![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/12.four_cylinders.png)
...
![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/13.selecting_all_cylinders.png)

In the *Inspector*, expand the *Material* section and assign a [StandardMaterial3D](class_StandardMaterial3D) to slot *0*.

![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/14.multi_material_selection.webp)

![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/standard_material.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/albedo_section.webp)

Set the color to something that contrasts with
the background, like a bright orange.

![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/15.bright-cylinders.png)
...
![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/16.cylinders_fold.png)
...
![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/17.points_options.png)
...
![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/18.close_path.png)

Your path should look like this.

![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/19.path_result.png)
...
![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/20.spawn_nodes.png)
...
![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/20.mob_scene_property.png)

Add a new [Timer](class_Timer) node as a child of ``Main``. Name it ``MobTimer``.

![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/21.mob_timer.png)

In the *Inspector*, set its *Wait Time* to ``0.5`` seconds and turn on
*Autostart* so it automatically starts when we run the game.

![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/22.mob_timer_properties.png)
...
![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/23.timeout_signal.png)

Connect it to the *Main* node.

![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/24.connect_timer_to_main.webp)
...
![Image](/img/GettingStarted/first_3d_game/img/05.spawning_mobs/25.spawn_result.png)
