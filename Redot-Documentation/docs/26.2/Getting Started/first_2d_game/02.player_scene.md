...
![Image](/img/GettingStarted/first_2d_game/img/add_node.webp)

When you add the ``Area2D`` node, Redot will display the following **warning icon**
next to it in the scene tree:

![Image](/img/GettingStarted/first_2d_game/img/no_shape_warning.webp)
...
![Image](/img/GettingStarted/first_2d_game/img/lock_children.webp)
...
`Cmd + A` on macOS) a child node [AnimatedSprite2D](class_AnimatedSprite2D). The ``AnimatedSprite2D`` will handle the
appearance and animations for our player. Notice that there is a warning symbol
next to the node. An ``AnimatedSprite2D`` requires a [SpriteFrames](class_SpriteFrames) resource, which is a list of the animations it can
...
![Image](/img/GettingStarted/first_2d_game/img/new_spriteframes.webp)

Click on the ``SpriteFrames`` you just created to open the "SpriteFrames" panel:

![Image](/img/GettingStarted/first_2d_game/img/spriteframes_panel.webp)
...
![Image](/img/GettingStarted/first_2d_game/img/spriteframes_panel2.webp)
...
![Image](/img/GettingStarted/first_2d_game/img/player_scale.webp)
...
![Image](/img/GettingStarted/first_2d_game/img/player_coll_shape.webp)

When you're finished, your ``Player`` scene should look like this:

![Image](/img/GettingStarted/first_2d_game/img/player_scene_nodes.webp)
