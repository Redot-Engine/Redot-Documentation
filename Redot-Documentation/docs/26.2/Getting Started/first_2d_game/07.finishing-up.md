...
And when you're ready, you can move on to [doc_your_first_3d_game](/en/26.2/Getting%20Started/first_3d_game/index) to learn
...
playable on. See [doc_exporting_projects](/en/26.2/Tutorials/export/exporting_projects) for instructions.
