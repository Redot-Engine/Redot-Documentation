...
Building upon the previous lesson, [doc_scripting_first_script](/en/26.2/Getting%20Started/step_by_step/scripting_first_script), let's look
at another important feature of any game: giving control to the player.
To add this, we need to modify our ``sprite_2d.gd`` code.

![Image](/img/GettingStarted/step_by_step/img/scripting_first_script_moving_with_input.gif)
...
1. The built-in input callbacks, mainly ``_unhandled_input()``. Like
   ...
   more about input callbacks, see [doc_inputevent](/en/26.2/Tutorials/inputs/inputevent).
...
In the next lesson, [doc_signals](/en/26.2/Getting%20Started/step_by_step/signals), we'll build upon the relationship between
