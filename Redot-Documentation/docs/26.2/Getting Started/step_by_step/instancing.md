...
Here's an example of a ball. It's composed of a [RigidBody2D](class_RigidBody2D) node as its root named Ball, which allows the ball to fall
and bounce on walls, a [Sprite2D](class_Sprite2D) node, and a
[CollisionShape2D](class_CollisionShape2D).

![Image](/img/GettingStarted/step_by_step/img/instancing_ball_scene.webp)
...
![Image](/img/GettingStarted/step_by_step/img/instancing_ball_instances_example.webp)
...
![Image](/img/GettingStarted/step_by_step/img/instancing_import_button.webp)

In the pop-up that appears navigate to the folder you extracted.
Double-click the ``project.Redot`` file to open it.

![Image](/img/GettingStarted/step_by_step/img/instancing_import_project_file.webp)

Finally, click the Import & Edit button.

![Image](/img/GettingStarted/step_by_step/img/instancing_import_and_edit_button.webp)
...
![Image](/img/GettingStarted/step_by_step/img/instancing_2d_scene_select.webp)

![Image](/img/GettingStarted/step_by_step/img/instancing_main_scene.webp)
...
![Image](/img/GettingStarted/step_by_step/img/instancing_scene_link_button.webp)

Double-click the ball scene to instance it.

![Image](/img/GettingStarted/step_by_step/img/instancing_instance_child_window.webp)

The ball appears in the top-left corner of the viewport.

![Image](/img/GettingStarted/step_by_step/img/instancing_ball_instanced.webp)

Click on it and drag it towards the center of the view.

![Image](/img/GettingStarted/step_by_step/img/instancing_ball_moved.webp)
...
![Image](/img/GettingStarted/step_by_step/img/instancing_ball_duplicated.webp)

You can repeat this process until you have several in the scene.

![Image](/img/GettingStarted/step_by_step/img/instancing_main_scene_with_balls.webp)
...
![Image](/img/GettingStarted/step_by_step/img/instancing_ball_scene_open.webp)

Select the Ball node. In the Inspector on the right, click on the PhysicsMaterial
property to expand it.

![Image](/img/GettingStarted/step_by_step/img/instancing_physics_material_expand.webp)

Set its Bounce property to ``0.5`` by clicking on the number field, typing ``0.5``,
and pressing `Enter`.

![Image](/img/GettingStarted/step_by_step/img/instancing_property_bounce_updated.webp)
...
![Image](/img/GettingStarted/step_by_step/img/instancing_scene_tabs.webp)

Select one of the instanced Ball nodes and, in the Inspector, set its Gravity
Scale value to ``10``.

![Image](/img/GettingStarted/step_by_step/img/instancing_property_gravity_scale.png)

A grey "revert" button appears next to the adjusted property.

![Image](/img/GettingStarted/step_by_step/img/instancing_property_revert_icon.png)
...
![Image](/img/GettingStarted/step_by_step/img/instancing_diagram_shooter.png)
...
![Image](/img/GettingStarted/step_by_step/img/instancing_diagram_open_world.png)
