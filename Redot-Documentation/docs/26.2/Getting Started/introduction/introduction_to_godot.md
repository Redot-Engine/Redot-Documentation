...
work. You can read more on that here: [doc_consoles](/en/26.2/Tutorials/platform/consoles).
...
You can code your games using [GDScript](/en/26.2/Tutorials/scripting/gdscript/index), a
Redot-specific and tightly integrated language with a lightweight syntax, or
[C#](/en/26.2/Tutorials/scripting/c_sharp/index), which is popular in the games industry.
...
[doc_learning_new_features](/en/26.2/Getting%20Started/introduction/learning_new_features).
