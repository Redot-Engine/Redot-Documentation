...
use it, see the [Editor manual](/en/26.2/Tutorials/editor/index).
...
[doc_project_manager](/en/26.2/Tutorials/editor/project_manager).
...
Just below the workspace buttons, the opened [scenes](/en/26.2/Getting%20Started/introduction/key_concepts_overview)
...
:::info
To learn more on workspaces, read [doc_intro_to_the_editor_interface_four_screens](/en/26.2/Getting%20Started/introduction/first_look_at_the_editor).

:::

:::info
To learn more on the 3D viewport and 3D in general, read [doc_introduction_to_3d](/en/26.2/Tutorials/3d/introduction_to_3d).
...
:::info
To read more on inspector, see [doc_editor_inspector_dock](/en/26.2/Tutorials/editor/inspector_dock).

:::

:::info
Docks can be customized. Read more on [doc_customizing_editor_moving_docks](/en/26.2/Tutorials/editor/customizing_editor).
...
:::note
Read [doc_introduction_to_3d](/en/26.2/Tutorials/3d/introduction_to_3d) for more detail about the **3D
main screen**.
